...
! function(a) { "function" == typeof define && define.amd ? define(["jquery"], a) : a(jQuery) }(function(a) {
    a.extend(a.fn, {
        validate: function(b) {
            if (!this.length) return void(b && b.debug && window.console && console.warn("Nada selecionado, não posso validar, não retornando nada."));
        ...
        messages: { required: "Este campo é obrigatório.", remote: "Por favor corrija este campo.", email: "Por favor insira um endereço de e-mail válido.", url: "Por favor, insira um URL válido.", date: "Por favor insira uma data válida.", dateISO: "Por favor insira uma data válida (ISO).", number: "por favor insira um número válido.", digits: "Por favor, digite apenas dígitos.", creditcard: "Por favor digite um número de cartão de crédito válido.", equalTo: "Por favor entre com o mesmo valor novamente.", maxlength: a.validator.format("Por favor, insira não mais que {0} caracteres."), minlength: a.validator.format("Por favor, insira pelo menos {0} caracteres."), rangelength: a.validator.format("Por favor insira um valor entre {0} e {1} caracteres."), range: a.validator.format("Por favor insira um valor entre {0} e {1}."), max: a.validator.format("Por favor insira um valor menor ou igual a {0}."), min: a.validator.format("Por favor insira um valor maior ou igual a {0}.") },
        autoCreateRanges: !1,
        prototype: {
            init: function() {
                function b(b) {
            ...
            elements: function() {
                var b = this,
                    c = {};
                return a(this.currentForm).find("input, select, textarea").not(":submit, :reset, :image, :disabled").not(this.settings.ignore).filter(function() { return !this.name && b.settings.debug && window.console && console.error("% não tem nome atribuído", this), this.name in c || !b.objectLength(a(this).rules()) ? !1 : (c[this.name] = !0, !0) })
            },
            ...
            defaultMessage: function(b, c) { return this.findDefined(this.customMessage(b.name, c), this.customDataMessage(b, c), !this.settings.ignoreTitle && b.title || void 0, a.validator.messages[c], "<strong>Aviso: nenhuma mensagem definida para " + b.name + "</strong>") },
